...
def outputvariable_str(keyvalue, variablename, freq = 'timestep')
  # This functino creates a string of Output:Variable statement
  # with keyvalue, variablename, and freq (defaulted timestep)
...
def ems_outputvar_creator(newoutputname, emsvarname, typedata = 1,
  ...
  misc_objects << outputvariable_str('*', newoutputname)

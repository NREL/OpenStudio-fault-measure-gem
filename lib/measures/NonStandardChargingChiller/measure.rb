...
# start the measure
class NonstandardChargingChiller < OpenStudio::Ruleset::WorkspaceUserScript
  # human readable name
  def name
    return 'Nonstandard Refrigerant Charging in Chiller'
  end
  ...
  def run(workspace, runner, user_arguments)
    ...
    runner.registerAsNotApplicable("NonstandardChargingChiller is not running for #{chiller_choice}. Skipping......")
    return true
  end
  ...
  def error_msg_for_not_rtu(runner, chiller_choice, existing_coils)
    ...
    runner.registerError("Measure NonstandardChargingChiller cannot find #{chiller_choice}. Exiting......")
...
NonstandardChargingChiller.new.registerWithApplication

...
class ExcessOilChiller < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  def description
    return 'Following Cheung and Braun (2016), this Measure simulates the effect of excess oil fault of water-cooled chillers with shell-and-tube condensers and evaporators to the building performance.'
  end
  ...
  def arguments(workspace)
    ...
    max_fl.setDefaultValue(0.68)
    args << max_fl

    # excess oil fault model
    args = enter_coefficients(args, $power_para_num, 'power_fault', [-6.513, -0.008258, 0.02976, 0.007701, 0.0, 0.04893], ' for the excess oil fault model')

    min_evap_tmp_fault = OpenStudio::Ruleset::OSArgument.makeDoubleArgument('min_evap_tmp_fault', true)
    min_evap_tmp_fault.setDisplayName('Minimum value of evaporator water outlet temperature for the excess oil fault model (C)')
    ...
    max_evap_tmp_fault.setDisplayName('Maximum value of evaporator water outlet temperature for the excess oil fault model (C)')
    ...
    min_cond_tmp_fault.setDisplayName('Minimum value of condenser inlet temperature for the excess oil fault model (C)')
    ...
    max_cond_tmp_fault.setDisplayName('Maximum value of condenser inlet temperature for the excess oil fault model (C)')
    ...
    min_cap_fault.setDisplayName('Minimum ratio of evaporator heat transfer rate to the reference capacity for the excess oil fault model')
    min_cap_fault.setDefaultValue(0.269)
    args << min_cap_fault

    max_cap_fault = OpenStudio::Ruleset::OSArgument.makeDoubleArgument('max_cap_fault', true)
    max_cap_fault.setDisplayName('Maximum ratio of evaporator heat transfer rate to the reference capacity for the excess oil fault model')

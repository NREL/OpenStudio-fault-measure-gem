...
# start the measure
class AteCheungChillerNonCondensable < OpenStudio::Ruleset::WorkspaceUserScript
  # human readable name
  def name
    return 'Water-cooled chiller with noncondensable fault (Cheung and Braun 2016)'
  end
  ...
  def run(workspace, runner, user_arguments)
    ...
    runner.registerAsNotApplicable("AteCheungChillerNonCondensable is not running for #{chiller_choice}. Skipping......")
    return true
  end
  ...
  def error_msg_for_not_rtu(runner, chiller_choice, existing_coils)
    ...
    runner.registerError("Measure AteCheungChillerNonCondensable cannot find #{chiller_choice}. Exiting......")
...
AteCheungChillerNonCondensable.new.registerWithApplication

...
class OpenStudio::Model::CoilCoolingWater
  ...
  def autosize
    ...
    self.autosizeDesignInletWaterTemperature
    self.autosizeDesignInletAirTemperature
    self.autosizeDesignOutletAirTemperature
    self.autosizeDesignInletAirHumidityRatio
    self.autosizeDesignOutletAirHumidityRatio
  end
  ...
  def applySizingValues
    ...
    if design_inlet_water_temperature.is_initialized and self.isDesignInletWaterTemperatureAutosized
    ...
    if design_inlet_air_temperature.is_initialized and self.isDesignInletAirTemperatureAutosized
    ...
    if design_outlet_air_temperature.is_initialized and self.isDesignOutletAirTemperatureAutosized
    ...
    if design_inlet_air_humidity_ratio.is_initialized and self.isDesignInletAirHumidityRatioAutosized
    ...
    if design_outlet_air_humidity_ratio.is_initialized and self.isDesignOutletAirHumidityRatioAutosized

...
class OpenStudio::Model::PumpConstantSpeed
  ...
  def applySizingValues
    ...
    if rated_flow_rate.is_initialized and self.isRatedFlowRateAutosized
      self.setRatedFlowRate(rated_flow_rate.get) 
    end
    
    rated_power_consumption = self.autosizedRatedPowerConsumption
    if rated_power_consumption.is_initialized and self.isRatedPowerConsumptionAutosized

...
class OpenStudio::Model::SizingSystem
  ...
  def applySizingValues
    ...
    require_relative 'HVACSizing.ControllerOutdoorAir'  # for the maximum outdoor airflow rate
    ...
    if air_loop.airLoopHVACOutdoorAirSystem.is_initialized
      ...
      if maximum_outdoor_air_flow_rate.is_initialized and self.isDesignOutdoorAirFlowRateAutosized
      ...
      elsif !controller_oa.isMaximumOutdoorAirFlowRateAutosized and self.isDesignOutdoorAirFlowRateAutosized
        # pass the manually defined outdoor airflow to the design value directly
        self.setDesignOutdoorAirFlowRate(controller_oa.maximumOutdoorAirFlowRate.get)
        self.setSystemOutdoorAirMethod("ZoneSum")
      end
    end

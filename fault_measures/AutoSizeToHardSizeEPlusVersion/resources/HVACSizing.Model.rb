...
class OpenStudio::Model::Model
  ...
  require_relative 'HVACSizing.AirTerminalSingleDuctVAVHeatAndCoolNoReheat'
  require_relative 'HVACSizing.AirTerminalSingleDuctVAVHeatAndCoolReheat'
  ...
  require_relative 'HVACSizing.AirTerminalSingleDuctVAVReheat'
  require_relative 'HVACSizing.AirTerminalSingleDuctVAVNoReheat'
  require_relative 'HVACSizing.AirTerminalSingleDuctUncontrolled'
  require_relative 'HVACSizing.AirLoopHVAC'
  require_relative 'HVACSizing.AirLoopHVACUnitaryHeatPumpAirToAir'
  require_relative 'HVACSizing.FanConstantVolume'
  ...
  def runSizingRun(sizing_run_dir = "#{Dir.pwd}/SizingRun", eplus_version = 8.2)
    ...
    if use_runmanager
      ...
      ep_hash = OpenStudio::EnergyPlus::find_energyplus(eplus_version.to_i,(eplus_version*10).to_i%10)
  ...
  def applySizingValues
    ...
    # self.getAirLoopHVACUnitaryHeatCoolVAVChangeoverBypass.sort.each {|obj| obj.applySizingValues} OS spreadsheet project shows NoMethod Error for this function
    ...
    # not running with any models that are not used in the FDD-OpenStudio seed models until further notice
    ...
    self.getAirTerminalSingleDuctVAVNoReheats.sort.each {|obj| obj.applySizingValues}
  ...
  def autosize
    ...
    self.getAirTerminalSingleDuctVAVNoReheats.sort.each {|obj| obj.autosize}

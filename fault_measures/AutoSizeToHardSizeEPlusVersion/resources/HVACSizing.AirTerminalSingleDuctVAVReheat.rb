...
class OpenStudio::Model::AirTerminalSingleDuctVAVReheat
  ...
  def autosize
    ...
    self.autosizeMaximumFlowFractionDuringReheat
    self.autosizeMaximumFlowPerZoneFloorAreaDuringReheat
  ...
  def applySizingValues
    ...
    if maximum_hot_water_or_steam_flow_rate.is_initialized and self.isMaximumHotWaterOrSteamFlowRateAutosized
    ...
    if maximum_flow_per_zone_floor_area_during_reheat.is_initialized and self.isMaximumFlowPerZoneFloorAreaDuringReheatAutosized
    ...
    if maximum_flow_fraction_during_reheat.is_initialized and self.isMaximumFlowFractionDuringReheatAutosized

...
class OpenStudio::Model::CoilHeatingDXSingleSpeed
  ...
  def applySizingValues
    ...
    if rated_total_heating_capacity.is_initialized and self.isRatedTotalHeatingCapacityAutosized
    ...
    if rated_resistive_defrost_heater_capacity.is_initialized and self.isResistiveDefrostHeaterCapacityAutosized

...
class OpenStudio::Model::ControllerOutdoorAir
  ...
  def applySizingValues
    ...
    if maximum_outdoor_air_flow_rate.is_initialized and self.isMaximumOutdoorAirFlowRateAutosized
    ...
    if minimum_outdoor_air_flow_rate.is_initialized and self.isMinimumOutdoorAirFlowRateAutosized

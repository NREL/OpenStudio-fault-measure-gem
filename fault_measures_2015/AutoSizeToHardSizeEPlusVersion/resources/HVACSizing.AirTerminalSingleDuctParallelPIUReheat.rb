...
class OpenStudio::Model::AirTerminalSingleDuctParallelPIUReheat
  ...
  def applySizingValues
    ...
    if maximum_primary_air_flow_rate.is_initialized and self.isMaximumPrimaryAirFlowRateAutosized
    ...
    if maximum_secondary_air_flow_rate.is_initialized and self.isMaximumSecondaryAirFlowRateAutosized
    ...
    if minimum_primary_air_flow_fraction.is_initialized and self.isMinimumPrimaryAirFlowFractionAutosized
    ...
    if fan_on_flow_fraction.is_initialized and self.isFanOnFlowFractionAutosized

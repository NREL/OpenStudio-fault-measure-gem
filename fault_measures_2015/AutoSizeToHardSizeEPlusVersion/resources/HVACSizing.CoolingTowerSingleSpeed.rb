...
class OpenStudio::Model::CoolingTowerSingleSpeed
  ...
  def autosize
    ...
    self.autosizeFanPoweratDesignAirFlowRate
    self.autosizeDesignAirFlowRate
    self.autosizeUFactorTimesAreaValueatDesignAirFlowRate
    self.autosizeAirFlowRateinFreeConvectionRegime
    self.autosizeUFactorTimesAreaValueatFreeConvectionAirFlowRate
  end
  ...
  def applySizingValues
    ...
    if fan_power_at_design_air_flow_rate.is_initialized and self.isFanPoweratDesignAirFlowRateAutosized
    ...
    if design_air_flow_rate.is_initialized and self.isDesignAirFlowRateAutosized
    ...
    if u_factor_times_area_value_at_design_air_flow_rate.is_initialized and self.isUFactorTimesAreaValueatDesignAirFlowRateAutosized
    ...
    if air_flow_rate_in_free_convection_regime.is_initialized and self.isAirFlowRateinFreeConvectionRegimeAutosized
    ...
    if u_factor_times_area_value_at_free_convection_air_flow_rate.is_initialized and self.isUFactorTimesAreaValueatFreeConvectionAirFlowRateAutosized

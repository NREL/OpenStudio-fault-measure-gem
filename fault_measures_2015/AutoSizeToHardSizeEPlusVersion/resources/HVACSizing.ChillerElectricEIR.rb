...
class OpenStudio::Model::ChillerElectricEIR
  ...
  def applySizingValues
    ...
    if reference_chilled_water_flow_rate.is_initialized and self.isReferenceChilledWaterFlowRateAutosized
    ...
    if reference_capacity.is_initialized and self.isReferenceCapacityAutosized
    ...
    if self.secondaryPlantLoop.is_initialized
      ...
      if reference_condenser_fluid_flow_rate.is_initialized and self.isReferenceCondenserFluidFlowRateAutosized
  ...
  def autosizedReferenceCondenserFluidFlowRate
    ...
    return self.model.getAutosizedValue(self, 'Design Size Reference Condenser Water Flow Rate', 'm3/s')

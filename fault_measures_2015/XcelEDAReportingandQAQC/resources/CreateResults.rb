...
def create_results()  
    ...
    annual_elems = OpenStudio::AttributeVector.new
      ...
      utility_cost_elems = OpenStudio::AttributeVector.new
		...
		@runner.registerInfo("Electricity cost: $#{electricity.get}")
		@runner.registerValue("electricity_cost", electricity.get, "$")
		...
		@runner.registerInfo("Gas cost: $#{gas.get}")
		@runner.registerValue("gas_cost", gas.get, "$")

...
=end
  ...
  # todo - this is failing because getschedulerulesetfromsetpointschedule is failing when there is no schedule
=begin
  def test_all_zones
    args = {}
    args["zone"] = '* All Zones *'
...
=end
  ...
  # todo - "Not Faulted" isn't supported as "dayofweek" on this measure, which is fine Make sure it doesn' show up when I share arg code unless it is setup to work
=begin
...
=end
  ...
  # todo - add tests for alternate values of ext_hr

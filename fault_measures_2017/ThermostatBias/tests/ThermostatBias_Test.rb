...
class ThermostatBias_Test < MiniTest::Unit::TestCase
  ...
  def test_good_argument_values
    ...
    expected_string_01 = 'Final annual average heating setpoint for Cafe_Flr_1 ZN 17.5 C'
    expected_string_02 = 'Final annual average cooling setpoint for Cafe_Flr_1 ZN 23.7 C'

...
def faultintensity_adjustmentfactor(string_objects, time_constant, time_step, start_month, start_date, start_time, end_month, end_date, end_time, fault_lvl, sch_choice)
  ...
  string_objects << "
      EnergyManagementSystem:Actuator,
        AFI,          !- Name
        #{sch_choice},           !- Actuated Component Unique Name

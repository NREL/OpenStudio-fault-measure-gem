...
class EconomizerOutdoorTempSensorBiasFault < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  # human readable name
  def name
    return "Economizer Outdoor Temperature Sensor Bias Fault"
  end

  # human readable description
  def description
    return "This Measure simulates the effect of economizer outdoor air temperature sensor fault of any RTU to the building performance."
  end
